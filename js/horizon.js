...
$(window).on('load', function () {
  $(function () {
    ...
    $(function () {
      ...
      $('.home-link').on('click', function () {
        gsap.to('.trans-project', .5, { scale: .9 });
        gsap.to('.trans-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.trans-project', 0, { display: 'none', delay: .7 });
        gsap.to('.combate-project', .5, { scale: .9 });
        gsap.to('.combate-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.combate-project', 0, { display: 'none', delay: .7 });
        gsap.to('.reco-project', .5, { scale: .9 });
        gsap.to('.reco-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.reco-project', 0, { display: 'none', delay: .7 });
        gsap.to('.adqui-project', .5, { scale: .9 });
        gsap.to('.adqui-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.adqui-project', 0, { display: 'none', delay: .7 });
        gsap.to('#about', .5, { scale: .9 });
        gsap.to('#about', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#about', 0, { display: 'none', delay: .7 });
      ...
      $('.adqui-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.adqui-project', 0, { display: 'block', delay: .7 })
        gsap.to('.adqui-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      $('.reco-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.reco-project', 0, { display: 'block', delay: .7 })
        gsap.to('.reco-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      $('.combate-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.combate-project', 0, { display: 'block', delay: .7 })
        gsap.to('.combate-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      $('.trans-project-link').on('click', function () {
        gsap.to('#home', .5, { scale: .9 });
        gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('#home', 0, { display: 'none', delay: .7 });
        gsap.to('.trans-project', 0, { display: 'block', delay: .7 })
        gsap.to('.trans-project', .5, { scale: 1, delay: 1.1 })
        gsap.to('.project-name', .5, { opacity: 0, delay: 2.5 })
        gsap.to('#breaker', { display: 'block' })
        gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
      })
      ...
      $('.combate-close').on('click', function () {
        gsap.to('.combate-project', .5, { scale: .9 });
        gsap.to('.combate-project', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
        gsap.to('.combate-project', 0, { display: 'none', delay: .7 });
        gsap.to('#home', 0, { display: 'block', delay: .7 })
